...
import (
	...
	dagger "github.com/frantjc/forge/internal/client"
)
...
func LoadForgeActionFromID(id dagger.ForgeActionID) *dagger.ForgeAction {
	client := initClient()
...
func LoadForgeFromID(id dagger.ForgeID) *dagger.Forge {
	client := initClient()
	return client.LoadForgeFromID(id)
}

// Load a ForgePostAction from its ID.
func LoadForgePostActionFromID(id dagger.ForgePostActionID) *dagger.ForgePostAction {
	client := initClient()
	return client.LoadForgePostActionFromID(id)
}
